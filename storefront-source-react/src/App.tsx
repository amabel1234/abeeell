  ...
  return (
    <main id="top" className="store-shell">
      ...
      <section id="reseller" className="section reseller-section">
        <div className="section-wrap">
          <div className="reseller-panel reseller-panel-expanded">
            <div>
              <span className="eyebrow">03 / build your circle</span>
              <h2>Turn Access Into Your Own Lane.</h2>
              <p className="reseller-lead">Masuk ke <strong>Reseller Circle Nixx</strong> dengan paket lengkap untuk kamu yang ingin menjual kembali, mengembangkan, dan mengkreasikan Script Nixx sesuai kebutuhanmu.</p>
              <div className="hero-actions">
                <WhatsAppButton product="Reseller Nixx VVIP" price="Rp120.000" label="Gabung Reseller" className="button-dark" />
              </div>
            </div>
            ...
            <div className="reseller-details">
              ...
              <div className="reseller-detail-block">
              ...
              <div className="reseller-detail-block">
                ...
                <blockquote>Buat versi kamu sendiri, tambahkan fitur, ubah tampilan, atau kembangkan sistemnya sesuai konsep yang kamu inginkan.</blockquote>
              </div>
              ...
              <div className="reseller-detail-block">
                ...
                <ul>
                  <li>🏪 Halaman toko sendiri</li>
                  <li>📦 Tampilan produk</li>
                  <li>🔑 Sistem penjualan akses</li>
                  <li>👥 Kelola pelanggan</li>
                  <li>⚡ Proses order lebih praktis</li>
                </ul>
              </div>
              ...
              <div className="reseller-summary">
                <span className="eyebrow">💎 Satu Paket, Banyak Kemungkinan</span>
                ...
                <p><strong>🔥 Siap Bergabung?</strong><br />Gabung Reseller Nixx dan mulai bangun versi kamu sendiri.</p>
              </div>

              <div className="reseller-price reseller-price-expanded"><small>Harga Paket Reseller</small>Rp120.000</div>
            </div>
          </div>
        </div>
      </section>
